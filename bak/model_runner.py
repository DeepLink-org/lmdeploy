...
class ModelRunner:
    ...
    def prepare_input_tensors(
        ...
        return (input_tokens, input_positions, attn_metadata,
                ...
                multi_modal_input)
    @record_function("vllm_execute_model")
    ...
    def execute_model(
        ...
        # output_path = f"/root/vllm_internlm2_7b/vllm_internlm2_7b_{record_count}.json"
        output_path = f"/home/SAIL/zhousl/vllm_llama3_8b/vllm_llama3_8b_{record_count}.json"

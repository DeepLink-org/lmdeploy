...
class MACADeviceUtils(BaseDeviceUtils):
    ...
    def update_step_context(cls, step_context):
        ...
        step_context.q_start_loc = step_context.q_start_loc.to(torch.int32)
        step_context.q_seq_length = step_context.q_seq_length.to(torch.int32)
